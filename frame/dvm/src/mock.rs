...
use crate::{
	...
	account_basic::{DvmAccountBasic, OxorRemainBalance, XorRemainBalance},
	*,
};
use codec::{Decode, Encode};
use oracol_evm::{AddressMapping, EnsureAddressTruncated, FeeCalculator, IssuingHandler};
...
impl oracol_evm::Config for Test {
	...
	type Event = ();
	type Precompiles = (
		oracol_evm_precompile_simple::ECRecover,
		oracol_evm_precompile_simple::Sha256,
		oracol_evm_precompile_simple::Ripemd160,
		oracol_evm_precompile_simple::Identity,
		oracol_evm_precompile_withdraw::WithDraw<Self>,
	);
	type ChainId = ChainId;
	type BlockGasLimit = BlockGasLimit;
	type Runner = oracol_evm::runner::stack::Runner<Self>;
...
frame_support::construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Oxor: oracol_balances::<Instance1>::{Pallet, Call, Storage},
		EVM: oracol_evm::{Pallet, Call, Storage},
...
pub fn new_test_ext(accounts_len: usize) -> (Vec<AccountInfo>, sp_io::TestExternalities) {
	...
	oracol_balances::GenesisConfig::<Test, XorInstance> { balances }
