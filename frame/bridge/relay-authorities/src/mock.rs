...
// --- oracol ---
use crate::{self as oracol_relay_authorities, *};
use oracol_relay_primitives::relay_authorities::Sign as SignT;
...
pub struct OracolMMR;
impl MMR<BlockNumber, H256> for OracolMMR {
...
frame_support::construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		RelayAuthorities: oracol_relay_authorities::{Pallet, Call, Storage, Config<T>, Event<T>}
	}
}
...
pub fn new_test_ext() -> TestExternalities {
	...
	.unwrap();
	oracol_relay_authorities::GenesisConfig::<Test, DefaultInstance> {
...
pub fn relay_authorities_events() -> Vec<Event> {
	events()
		.into_iter()
		.filter(|e| matches!(e, Event::oracol_relay_authorities(_)))
		.collect()
}
