...
macro_rules! decl_tests {
	($($pallet:tt)*) => {
		...
		// --- oracol ---
		use crate as oracol_ethereum_backing;
		use oracol_staking::{EraIndex, Exposure, ExposureOf};
		...
		impl oracol_staking::Config for Test {
		...
		frame_support::parameter_types! {
			...
			pub const XorLockLimit: Balance = 1000;
			pub const OxorLockLimit: Balance = 1000;
		...
		frame_support::construct_runtime! {
				...
				UncheckedExtrinsic = UncheckedExtrinsic
			{
				...
				Xor: oracol_balances::<Instance0>::{Pallet, Call, Storage},
				Oxor: oracol_balances::<Instance1>::{Pallet, Call, Storage},
				Staking: oracol_staking::{Pallet, Call, Storage},
				Session: pallet_session::{Pallet, Call, Storage},
				EthereumBacking: oracol_ethereum_backing::{Pallet, Call, Storage, Config<T>},
				$($pallet)*,
			}
		}
	};
