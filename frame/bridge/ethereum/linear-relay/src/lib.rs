...
//! # Oracol-ethereum-linear-relay Module
//!
//! Prototype module for bridging in Ethereum pow blockchain, including Mainnet and Ropsten.
//!
//! ## Overview
//!
//! The oracol eth linear relay module itself is a chain relay targeting Ethereum networks to
//! Oracol networks. This module follows the basic linear chain relay design which
...
decl_storage! {
	trait Store for Module<T: Config> as OracolEthereumLinearRelay {
