...
// --- oracol ---
use crate::{self as oracol_ethereum_linear_relay, *};
...
frame_support::construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		EthereumRelay: oracol_ethereum_linear_relay::{Pallet, Call, Storage, Config<T>},
	}
}
...
impl ExtBuilder {
	...
	pub fn build(self) -> sp_io::TestExternalities {
		...
		oracol_ethereum_linear_relay::GenesisConfig::<Test> {
