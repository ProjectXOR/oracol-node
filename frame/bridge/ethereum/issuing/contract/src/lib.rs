...
impl Abi {
	...
	/// @params fee: register fee from the outer chain to oracol
	...
	/// @params recipient: the receiver on oracol of the asset
	/// @params fee: transfer fee from the outer chain to oracol
...
/// token register info
/// this is the response from oracol after token registered
...
/// token burn info
/// this is the event proof from oracol after some user burn their mapped token
