...
//! need some soldoxorg assumptions about the particular runtime.
//!
...
use xor_primitives::{AccountId, Balance, BlockNumber, Hash, Nonce, OpaqueBlock as Block, Power};
...
where
	...
	C::Api: oracol_balances_rpc::BalancesRuntimeApi<Block, AccountId, Balance>,
	C::Api: oracol_header_mmr_rpc::HeaderMMRRuntimeApi<Block, Hash>,
	C::Api: oracol_staking_rpc::StakingRuntimeApi<Block, AccountId, Power>,
	...
	B::State: sc_client_api::StateBackend<sp_runtime::traits::HashFor<Block>>,
{
	...
	// --- oracol ---
	use oracol_balances_rpc::{Balances, BalancesApi};
	use oracol_header_mmr_rpc::{HeaderMMR, HeaderMMRApi};
	use oracol_staking_rpc::{Staking, StakingApi};
	use dc_rpc::{
	...
	use oracol_runtime::TransactionConverter;
