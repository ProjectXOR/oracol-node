...
// --- oracol ---
use crate::*;
use oracol_treasury::{weights::SubstrateWeight, Config};

frame_support::parameter_types! {
	pub const TreasuryModuleId: ModuleId = ModuleId(*b"da/trsry");
	pub const ProposalBond: Permill = Permill::from_percent(5);
	pub const XorProposalBondMinimum: Balance = 20 * COIN;
	pub const OxorProposalBondMinimum: Balance = 20 * COIN;
...
impl Config for Runtime {
	...
	type Event = Event;
	type OnSlashXor = Treasury;
	type OnSlashOxor = Treasury;
	...
	type XorBurnDestination = ();
	type OxorBurnDestination = ();
