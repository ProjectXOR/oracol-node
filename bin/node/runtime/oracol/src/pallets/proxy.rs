		...
		match self {
			...
			ProxyType::NonTransfer => matches!(
				...
				Call::System(..) |
							...
							Call::Vesting(oracol_vesting::Call::vest(..)) |
							Call::Vesting(oracol_vesting::Call::vest_other(..)) |
							Call::Utility(..)|
							Call::Identity(..)|
							Call::Society(..)|
							...
							Call::Multisig(..)|
							Call::HeaderMMR(..)|
							// Specifically omitting the entire OldxorIssuing pallet
							// Specifically omitting the entire OldxorBacking pallet
							Call::EthereumRelay(..) |
							// Specifically omitting the entire EthereumBacking pallet
							Call::EthereumRelayAuthorities(..) // Specifically omitting the entire OldoxorBacking pallet
