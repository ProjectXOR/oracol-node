...
pub const XOR: CurrencyId = CurrencyId::Token(TokenSymbol::XOR);
pub const RUSD: CurrencyId = CurrencyId::Token(TokenSymbol::RUSD);

parameter_types! {
	pub const GetNativeCurrencyId: CurrencyId = XOR;
}
...
pub const XOR_ERC20_ADDRESS: &str = "0x0000000000000000000000000000000001000000";
