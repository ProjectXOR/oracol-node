...
parameter_types! {
	...
	// pub TreasuryModuleAccount: AccountId = OracolTreasuryModuleId::get().into_account();
}
...
parameter_types! {
	pub const BasicDeposit: Balance =      100 * XOR;
	pub const FieldDeposit: Balance =        1 * XOR;
	pub const SubAccountDeposit: Balance =  20 * XOR;
...
parameter_types! {
	pub const IndexDeposit: Balance = 1 * XOR;
}
...
parameter_types! {
	pub const GetNativeCurrencyId: CurrencyId = CurrencyId::Token(TokenSymbol::XOR);
...
parameter_types! {
	pub const TransactionByteFee: Balance = 10 * MILLI_XOR;
...
parameter_types! {
	...
	// 10 XOR minimum storage deposit
...
parameter_types! {
	...
	pub const NativeTokenExistentialDeposit: Balance =       1 * XOR;
	pub const MaxNativeTokenExistentialDeposit: Balance = 1000 * XOR;
...
parameter_types! {
	...
	pub const CandidacyDeposit: Balance =   1_000_000 * primitives::currency::XOR;
	pub const MinLockAmount: Balance =        100_000 * primitives::currency::XOR;
	pub const TotalLockedCap: Balance = 2_000_000_000 * primitives::currency::XOR;
}
