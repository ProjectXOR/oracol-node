...
# This script is customized from Substrate to adapt to Oracol project.
...
function check_rule() {
	...
	case "$from" in 
		*/*)
			echo "oracol-ensure-dep.sh is not ready to parsing $from and handle / "
			echo "please help us to do this like $to part"
			echo "read https://github.com/oracol-network/oracol/pull/401 to know more about it"
			exit 1
		;;
	esac
