...
pub struct RelayAuthority<AccountId, Signer, XorBalance, BlockNumber> {
	pub account_id: AccountId,
	pub signer: Signer,
	pub stake: XorBalance,
	pub term: BlockNumber,
}
impl<AccountId, Signer, XorBalance, BlockNumber> PartialEq
	for RelayAuthority<AccountId, Signer, XorBalance, BlockNumber>
where
	AccountId: PartialEq,
{
...
impl<AccountId, Signer, XorBalance, BlockNumber> PartialEq<AccountId>
	for RelayAuthority<AccountId, Signer, XorBalance, BlockNumber>
where
	AccountId: PartialEq,
{
...
pub struct ScheduledAuthoritiesChange<AccountId, Signer, XorBalance, BlockNumber> {
	/// The new authorities after the change
	pub next_authorities: Vec<RelayAuthority<AccountId, Signer, XorBalance, BlockNumber>>,
